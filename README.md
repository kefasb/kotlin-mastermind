...
Text copied from Coursera: https://www.coursera.org/learn/kotlin-for-java-developers/programming/vmwVT/mastermind-game/instructions
...
After implementing the task for repeated letters, run `MastermindTestRepeatedLetters` to make sure
it works correctly.